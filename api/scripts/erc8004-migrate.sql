...
-- Remove deprecated legacy columns.
ALTER TABLE agents
  DROP COLUMN IF EXISTS agent0_chain_id,
  DROP COLUMN IF EXISTS agent0_agent_id,
  DROP COLUMN IF EXISTS agent0_agent_uri,
  DROP COLUMN IF EXISTS agent0_metadata;
